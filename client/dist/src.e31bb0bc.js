...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('http://0.0.0.0:3000/api/wallet-info').then(function (response) {
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, "Welcome to the Blockchain...", _react.default.createElement("div", null, "Address: ", address), _react.default.createElement("div", null, "Balance: ", balance));
    }
  }]);
...
console.log('Hello, World!'); // Import node modules
